...
import com.syn.smsp.param.ActionParam;
...
public class ActionUtil {
	...
	public static void setCurrPage(Integer currPage) {
		ActionUtil.getActionParam().setCurrPage(currPage);
	}

	public static Integer getCurrPage() {
		return ActionUtil.getActionParam().getCurrPage();
	}
}
