	...
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-menu-edit">
				...
				<div class="col-sm-8">
	                <c:choose>
					  ...
					  <c:when test="${menu.menuType=='C'}">
						  ...
						  <label class="radio-box"> <input type="radio"  name="menuType" value="C" checked/> 菜单 </label>
						  <%--<label class="radio-box"> <input type="radio"  name="menuType" value="F" /> 按钮 </label>--%>
					  </c:when>
					  <c:otherwise>
						  <label class="radio-box"> <input type="radio"  name="menuType" value="M"  /> 目录 </label>
						  <label class="radio-box"> <input type="radio"  name="menuType" value="C" /> 菜单 </label>
						  <%--<label class="radio-box"> <input type="radio"  name="menuType" value="F" checked/> 按钮 </label>--%>
					  </c:otherwise>
					</c:choose>
				</div>
			</div>
	        ...
	        <div class="form-group">
				...
				<div class="col-sm-8">
				<c:choose>
					<c:when test="${menu.visible=='0'}">
					 <label class="radio-box"> <input type="radio"   value="0" name="visible" checked/> 显示 </label>
					...
					<c:otherwise>
						...
						<label class="radio-box"> <input type="radio"   value="1" name="visible" checked/> 隐藏 </label>
					</c:otherwise>
				</c:choose>
				</div>
			</div>
...
<script src="/goldenetbj/menu/edit.js" ></script>
</body>
</html>
