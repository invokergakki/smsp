...
<div class="form-content">
    <form id="form-sensor-add" class="form-horizontal">
        <input name="deptId" type="hidden" id="treeId"/>
        <h4 class="form-header h4">新增设备</h4>
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-4 control-label">编号: </label>
                    <div class="col-sm-8">
                        <input name="IMEI" autocomplete="off" placeholder="请输入编号" class="form-control" type="text"  maxlength="140">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="imeiName"  placeholder="请输入名称" autocomplete="off" class="form-control" type="text" maxlength="140" >
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="phone"  placeholder="请输入名称" autocomplete="off" class="form-control" type="text"minlength="11"  maxlength="11" >
                    </div>
                </div>
            </div>
        </div>
        ...
        <%--<input id="sensorPicture" name="sensorPicture" readonly="readonly" type="text" style="border:1px solid #d9d9d9;width:150px;height:32px;">--%>
        <%--</label>--%>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <div style="border:1px solid #d9d9d9;width:85%;margin-left:100px;">
                        ...
                        条件： <input name="city" type="text" maxlength="20" id="city" onclick="getAddr()" style="width:200px;" value="北京"/> <input type="button" value="查询" name="btn" onclick="getAddr();" style="font-size: 12px;" />
                        ...
                        地址： <input name="sensorLocation" type="text" maxlength="20" id="sensorLocation" style="font-size:16px;width:200px;" value="北京" />
                        <br/><br/>
                    </div>
                </div>
            </div>
...
<script src="/goldenetbj/sensor/add.js" ></script>
